...
<?php if ('open' == $post->comment_status) { ?>
	...
	<div id="respond">
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<div id="submitbox">
				<div id="c_textarea">
					<textarea name="comment" id="comment" tabindex="4" onkeydown="if(event.ctrlKey&amp;&amp;event.keyCode==13){document.getElementById('submit').click();return false};" placeholder="请自觉遵守互联网相关政策法规，严谨发布广告、色情、暴力反动的言论。发现永久封IP禁止访问！"></textarea>
				</div>
				<div id="c_input">
